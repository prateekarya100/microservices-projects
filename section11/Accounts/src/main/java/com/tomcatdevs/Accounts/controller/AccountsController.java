...
public class AccountsController {
    ...
    public AccountsController(IAccountsService iAccountsService,
                              ContactInfoAccountsDevTeam accountsDevTeam,
    ...
    public ResponseEntity<String> getBuildVersion() throws TimeoutException {
        logger.info("method getBuildVersion() invoked - attempt at {}", retryCounter.incrementAndGet());
//        throw new RuntimeException("Simulated RuntimeException failure");
//        throw new NullPointerException("null pointer exception invoked");
//        throw new TimeoutException("timeout exception invoked");
        return ResponseEntity.status(HttpStatus.OK).body(buildVersion);
    }

    public ResponseEntity<String> getBuildVersionFallback(Throwable throwable){
        logger.info("Fallback triggered: {}", throwable.getMessage());
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("v4.1.2");
    }
